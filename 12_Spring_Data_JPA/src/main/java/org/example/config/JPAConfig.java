...
public class JPAConfig {
    @Bean
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource ds , JpaVendorAdapter dataSource) {
        LocalContainerEntityManagerFactoryBean em = new LocalContainerEntityManagerFactoryBean();
        em.setDataSource(ds);
        em.setJpaVendorAdapter(dataSource);
    ...
    public JpaVendorAdapter jpaVendorAdapter() {
        ...
        adapter.setDatabasePlatform("org.hibernate.dialect.MySQLDialect.class");
        return adapter;
    }
